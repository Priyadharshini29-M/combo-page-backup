      ...
      <Layout>
        ...
        <Layout.Section variant="oneHalf">
          ...
          <Card title="Discount Offer" sectioned>
            <FormLayout>
              {/* New Dropdown Option Above Discount Position */}
              <div style={{ marginBottom: "16px" }}>
                <Select
                  label="New Option Dropdown"
                  options={[
                    { label: "Default Layout", value: "option1" },
                    {
                      label: "Title, Banner, Preview, Products",
                      value: "option2",
                    },
                    { label: "Products First", value: "option3" },
                    { label: "Banner Always Second", value: "option4" },
                    { label: "Preview Bar Last", value: "option5" },
                    { label: "Preview Bar First", value: "option6" },
                  ]}
                  value={config.new_option_dropdown || "option1"}
                  onChange={(v) => updateConfig("new_option_dropdown", v)}
                />
              </div>
              <div style={{ marginBottom: "16px" }}>
...
function ComboPreview({ config, device }) {
  ...
  const renderPreviewBar = () => (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 6, alignItems: previewAlignItems }}>
        <span
          style={{
  ...
  // Section order logic based on dropdown
  let sectionOrder = [
    renderBanner,
    renderPreviewBar,
  ...
  if (config.new_option_dropdown === "option2") {
    sectionOrder = [
      renderTitleDescription,
      renderBanner,
      renderPreviewBar,
    ...
    // Banner always second: Title, Banner, Preview, Products
    sectionOrder = [
      renderTitleDescription,
      renderBanner,
      renderPreviewBar,
    ...
    // Preview Bar Last: Banner, Title, Products, Preview
    sectionOrder = [
      renderBanner,
      renderTitleDescription,
      renderProductsGrid,
    ...
    // Preview Bar First: Preview, Banner, Title, Products
    sectionOrder = [
      renderPreviewBar,
      renderBanner,
      renderTitleDescription,
